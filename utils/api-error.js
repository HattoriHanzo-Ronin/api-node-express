...
export default class ApiError extends Error {
    ...
    static ERROR = Object.freeze({
        ...
        DEVICE_NAME_ALREADY_EXISTS: { code: "DEVICE_NAME_ALREADY_EXISTS" },
        DEVICE_IP_ALREADY_IN_USE: { code: "DEVICE_IP_ALREADY_IN_USE" },
        DEVICE_NOT_FOUND: { code: "DEVICE_NOT_FOUND" },
        DEVICE_EMPTY_UPDATE: { code: "DEVICE_EMPTY_UPDATE" },
        CONNECTION_REQUIRED: { code: "CONNECTION_REQUIRED" },
        CONNECTION_MAC_ALREADY_EXISTS: { code: "CONNECTION_MAC_ALREADY_EXISTS" },
        CONNECTION_CREATE_FAILED: { code: "CONNECTION_CREATE_FAILED" },
        CONNECTION_UPDATE_FAILED: { code: "CONNECTION_UPDATE_FAILED" },
        CONNECTION_MAC_MISMATCH: { code: "CONNECTION_MAC_MISMATCH" },
        ...
        REFRESH_TOKEN_USER_NOT_FOUND: { code: "REFRESH_TOKENS_USER_NOT_FOUND" },
        ...
        USER_EMPTY_UPDATE: { code: "USER_EMPTY_UPDATE" },
